...
function Header(props) {
	return React.createElement(
		'div',
		{ id: 'header' },
		React.createElement('select', { id: 'h00' }),
		React.createElement(
			'select',
			{ id: 'h01', className: 'phantom' },
	...
	_createClass(App, [{
			...
			$.ajax('http://' + host + ':' + port + '/getAll', {
				success: function success(r) {
					...
					r.forEach(function (e) {
						$('<option></option>').html(e.name).attr('value', e.name).insertBefore($('#new'));
					});
				}
			});
		}
		...
		value: function render() {
			...
			return React.createElement(
				'div',
				{ id: 'container' },
				React.createElement(Header, { handleNew: function handleNew() {
						return _this3.handleNew;
					} }),
				React.createElement(
					'div',
					{ id: 'main' },
